              ...
              GridView.count(
                ...
                children: [
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'images/img1.jpg', 123, 456, 1),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'images/img2.jpg', 123, 456, 2),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'images/img4.jpg', 123, 456, 3),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'images/img5.jpg', 123, 456, 4),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'images/img6.jpg', 123, 456, 5),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'images/img7.jpg', 123, 456, 6),
                ],
              )
            ],
          )
