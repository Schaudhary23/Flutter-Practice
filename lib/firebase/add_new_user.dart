...
import 'package:flutter_training/firebase_controller/service_controller.dart';
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        setState(() {
                          ...
                          addUser();
                          controller.registerUser(emailId, password);
                        });
                        // GetX<AuthenticationServiceController>(
                        //     builder: ((controller) {
                        //     controller.registerUser(emailId, password);
                        // }),);
                      }
